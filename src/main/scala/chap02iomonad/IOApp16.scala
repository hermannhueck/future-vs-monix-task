...
/*
  Step 16 provides two refactorings:
  ...
  - The synchronous run* methods (run, runToTry, runToEither) all take an implicit EC
    in order to eable async execution as well.
 */
